...
class WarCardGame:
    ...
    def check_game_over(self):
        if self._player.has_empty_deck() or self._computer.has_empty_deck():
            print('=========================================')
            print('=|               Game Over             |=')
            print('=========================================')
        else:
        ...
        if self._player.has_empty_deck():
            ...
            print (f'Excecllent. You won, {self._player.name}! Congratulations!')
            return True
